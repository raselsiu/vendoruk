            ...
            <div class="col-lg-4 col-md-6 col-sm-7">
                <div class="footer__about">
                    ...
                    <div class="footer__payment">
                        <a href="#"><img src="{{ asset('assets/frontend/img/payment/payment-1.png') }}"
                                alt=""></a>
                        <a href="#"><img src="{{ asset('assets/frontend/img/payment/payment-2.png') }}"
                                alt=""></a>
                        <a href="#"><img src="{{ asset('assets/frontend/img/payment/payment-3.png') }}"
                                alt=""></a>
                        <a href="#"><img src="{{ asset('assets/frontend/img/payment/payment-4.png') }}"
                                alt=""></a>
                        <a href="#"><img src="{{ asset('assets/frontend/img/payment/payment-5.png') }}"
                                alt=""></a>
                    </div>
                </div>
            </div>
